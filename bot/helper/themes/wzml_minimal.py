...
class WZMLStyle:
    ...
    ST_BN2_NAME = 'Updates'
    ST_BN2_URL = 'https://t.me/SS_Bot18'
    ST_MSG = '''<i>This bot can Leech Videos Or Documnets Files From your ddl-links | files | torrents to Google Drive or any rclone cloud or to telegram or to ddl servers.</i>
